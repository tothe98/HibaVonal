    ...
    return (
        <>
            <main
                ...
                `}
            >
                <MenuButton id="1" label="My Issue List" onClick={() => logout()}>
                ...
                <MenuButton id="2" label="Report Issue" onClick={() => logout()}>
                ...
                <MenuButton id="3" label="Edit Profile" onClick={() => logout()}>
                ...
                <MenuButton id="4" label="Logout" onClick={() => logout()}>
