        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PersonInChargeContact = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PersonalRoomId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_User_Room_PersonalRoomId",
                        column: x => x.PersonalRoomId,
                        principalTable: "Room",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OrderItem_Equipment_EquipmentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Dormitory_AddressId",
                table: "Dormitory",
                column: "AddressId");

            migrationBuilder.CreateIndex(
                name: "IX_Equipment_ErrorTypeId",
                table: "Equipment",
                column: "ErrorTypeId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ErrorLog_MaintenanceWorkerId",
                table: "ErrorLog",
                column: "MaintenanceWorkerId");

            migrationBuilder.CreateIndex(
                name: "IX_ErrorLog_ReporterId",
                table: "ErrorLog",
                column: "ReporterId");

            migrationBuilder.CreateIndex(
                name: "IX_ErrorLog_RoomId",
                table: "ErrorLog",
                column: "RoomId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_User_PersonalRoomId",
                table: "User",
                column: "PersonalRoomId");
